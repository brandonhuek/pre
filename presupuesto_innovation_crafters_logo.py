...
def generar_pdf():
    ...
    # Insertar logo
    try:
        c.drawImage("logo_innovation_crafters.png", 2 * cm, height - 3 * cm, width=4 * cm, preserveAspectRatio=True)
    except:
        pass

    c.setFont("Helvetica-Bold", 16)
    c.drawCentredString(width / 2, height - 3.5 * cm, "Presupuesto personalizado Innovation Crafters")

    c.setFont("Helvetica-Bold", 12)
    c.drawString(2 * cm, height - 4.8 * cm, t["client_data"])
